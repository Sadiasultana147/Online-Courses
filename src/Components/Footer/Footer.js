...
const url1 ='https://i.ibb.co/CzzjkFf/footericon.png';
    ...
    return (
       ...
       <footer className='footer'>
           ...
           <img className='footer-img' src={url} alt="" />
            ...
            <div>
            <img className='footer-img1' src={url1} alt="" />
            </div>
           </div>
           <hr  />
               ...
               <div>
                 ...
                 <div>
                  <NavLink className='navlink' to = "/#">
                       Programming-Skill-Center
                   </NavLink>
                  </div>
                   <div>
                   <NavLink className='navlink' to = "/#">
                       Programming-Skill-Center Forum
                   </NavLink>
                   </div>
                   <div>
                   <NavLink className='footerlink' to = "/#">
                       Programming-Skill-Center Blog
                   </NavLink>
                   </div>
                 </div>
               </div>
